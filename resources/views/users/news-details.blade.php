    ...
    <div class="container">
               ...
               <div class="blog-tags">
                ...
                <div class="wrap__profile">
                    <div class="wrap__profile-author">
                        <figure>
                            <img style="object-fit: cover;" src="{{ asset($news->auther->image) }}" alt="" class="img-fluid rounded-circle">
                        </figure>
        ...
        <div class="ads-left">
            <a href="{{ $ad->ads_banner_left_url }}">
                <img src="{{ asset($ad->ads_banner_left) }}" alt="adds">
            </a>
        </div>
        @endif
        ...
        <div class="ads-right">
            <a href="{{ $ad->ads_banner_right_url }}">
                <img src="{{ asset($ad->ads_banner_right) }}" alt="adds">
            </a>
        </div>
        @endif
    </div>
