        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <!--        <img data-src="{{ asset($ad->home_middle_ad) }}" alt="adds">-->
                    <!--       </a>-->
                    <!--    </div>-->
                    <!--</div>-->
                    <!--@endif-->
                ...
                <div class="col-md-4">
                    <div class="sticky-top">
                        ...
                        <!--<aside class="wrapper__list__article">-->
                        <!--    <h4 class="border_section">{{ __('stay connected with us') }}</h4>-->
                            <!-- widget Social media -->
                        ...
                        <aside class="wrapper__list__article">
                            ...
                            <a href="{{ $ad->side_bar_ad_url }}">
                                <figure>
                                    <img data-src="{{ asset($ad->side_bar_ad) }}" alt="" class="img-fluid lazy" loading="lazy">
                                </figure>
                            </a>
                        </aside>
                        @endif
