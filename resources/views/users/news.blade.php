...
@section('title', $category ? $category->name : 'kaptenforex')
@section('meta_keyword', $category ? $category->meta_keyword : 'Tips pengasuhan anak, Panduan kesehatan keluarga, Gaya hidup keluarga, Pengasuhan kreatif, Solusi sukses bisnis, Keseimbangan kerja dan keluarga, Tips keharmonisan keluarga, Sumber terpercaya parenting, Teknologi, keluarga, Panduan praktis bisnis, Tips perkembangan anak, Aktivitas kreatif keluarga, Perencanaan keuangan keluarga, Parenting dan teknologi, Tips kesehatan keluarga, tips bisnis, cara memulai bisnis, keuangan')
@section('meta_description', $category ? $category->meta_description : 'kaptenforex adalah sumber terpercaya untuk teknologi, ekonomi bisnis, parenting, dan gaya hidup. Temukan tips pengasuhan anak, panduan kesehatan keluarga, serta inspirasi untuk kehidupan kreatif dan harmonis bersama anak. Dapatkan solusi praktis dan inspiratif untuk mendukung kesuksesan bisnis dan keseimbangan hidup keluarga.')
@section('meta_og_title', $category ? $category->name : 'kaptenforex')
@section('meta_og_description', $category ? $category->meta_description : 'kaptenforex adalah sumber terpercaya untuk teknologi, ekonomi bisnis, parenting, dan gaya hidup. Temukan tips pengasuhan anak, panduan kesehatan keluarga, serta inspirasi untuk kehidupan kreatif dan harmonis bersama anak. Dapatkan solusi praktis dan inspiratif untuk mendukung kesuksesan bisnis dan keseimbangan hidup keluarga.')
@section('meta_tw_title', $category ? $category->name : 'kaptenforex')
