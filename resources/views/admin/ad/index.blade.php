        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="{{ route('admin.ad.update', 1) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <h5 class="text-primary">{{ __('Banner Ads') }}</h5>

                    <div class="form-group">
                        <img src="{{ asset($ad->ads_banner_left) }}" width="200px" alt="">
                        <br>
                        <label for="ads_banner_left">{{ __('admin.Banner Left') }}</label>
                        <input name="ads_banner_left" id="ads_banner_left" type="file" class="form-control">
                        @error('ads_banner_left')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    
                        <label for="ads_banner_left_url" class="mt-3">{{ __('admin.Banner Left Url') }}</label>
                        <input name="ads_banner_left_url" id="ads_banner_left_url" value="{{ $ad->ads_banner_left_url }}" type="text" class="form-control">
                        @error('ads_banner_left_url')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    
                        <label class="custom-switch mt-2">
                            <input
                                {{ $ad->ads_banner_left_status == 1 ? 'checked' : '' }}
                                name="ads_banner_left_status"
                                value="1" type="checkbox" class="custom-switch-input toggle-status">
                            <span class="custom-switch-indicator"></span>
                        </label>
                    </div>
                    ...
                    <div class="form-group">
                        <img src="{{ asset($ad->ads_banner_right) }}" width="200px" alt="">
                        <br>
                        <label for="ads_banner_right">{{ __('admin.Banner Right') }}</label>
                        <input name="ads_banner_right" id="ads_banner_right" type="file" class="form-control">
                        @error('ads_banner_right')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    
                        <label for="ads_banner_right_url" class="mt-3">{{ __('admin.Banner Right Url') }}</label>
                        <input name="ads_banner_right_url" id="ads_banner_right_url" value="{{ $ad->ads_banner_right_url }}" type="text" class="form-control">
                        @error('ads_banner_right_url')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    
                        <label class="custom-switch mt-2">
                            <input
                                {{ $ad->ads_banner_right_status == 1 ? 'checked' : '' }}
                                name="ads_banner_right_status"
                                value="1" type="checkbox" class="custom-switch-input toggle-status">
                            <span class="custom-switch-indicator"></span>
                        </label>
                    </div>
