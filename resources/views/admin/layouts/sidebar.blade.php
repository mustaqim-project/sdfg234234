    ...
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
           <figure class="mb-0 mx-auto">
                    <a href="https://kaptenforex.com">
                        <img src="https://kaptenforex.com/uploads/uLvyvgE4jJFrK6efQWKZBh20IHaZqa.webp" class="img-fluid logo" aria-label="Go to kaptenforex" alt="kaptenforex Logo" style="width: 120px;">
                    </a>
                </figure>
        </div>
           ...
           @if (canAccess(['news index', 'image index']))
                <li class="dropdown {{ setSidebarActive(['admin.news.*', 'admin.pending.news', 'admin.images.*']) }}">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="{{ setSidebarActive(['admin.image.index']) }}">
                            <a class="nav-link" href="{{ route('admin.image.index') }}">{{ __('Image Gallery') }}</a>
                        </li>
                    </ul>
                </li>
            @endif
